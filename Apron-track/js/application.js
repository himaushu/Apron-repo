$(document).ready(function(){
    ...
    */
    ...
    $('#signUp').off('click').on('click',function(){
      window.location.href = 'http://meeknflair.com/admin/';
    });
    ...
    */
    if(pageWidth > 980){
        ...
        $('#pg-welcome').parallax("0%", 0.2);
        $('#pg-features').parallax("0%", 0.07);
        $('#pg-team').parallax("0%", 0.07);
        $('#pg-twitter').parallax("0%", 0.1);
    }
    ...
    */
    $('#pg-welcome .logo a').click(function(){
        $('html, body').animate({
